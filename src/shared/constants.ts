import { Business, BusinessHours, Category, Coupon, UserCoord } from "./types";
...
const DEFAULT_HOURS: BusinessHours[] = [
    ...
    { day: "Sábado",    open: "10:00", close: "21:00" },
    { day: "Domingo",   open: "10:00", close: "18:00" },
];

export const BUSINESSES: Business[] = [
    {
        id: "b-tanta", ruc: "20501035008", name: "Tanta",
        address: "Av. Pardo 1145, Miraflores", district: "Miraflores",
        phone: "01 444-2323", email: "contacto@tantarestaurante.com", website: "tantarestaurante.com",
        category: "food", rating: 4.7, totalReviews: 312,
        description: "Restaurante de cocina peruana casual del Grupo Gastón Acurio. Recetas tradicionales con ingredientes frescos de temporada.",
        lat: -12.1232, lng: -77.0301,
        imageUrl: "https://images.unsplash.com/photo-1761315414522-a732eb715497?w=800&q=80",
        hours: [
    ...
    {
        id: "b-bodega-verde", ruc: "20523406894", name: "La Bodega Verde",
        address: "Calle Berlín 320, Miraflores", district: "Miraflores",
        phone: "01 241-9901", email: "hola@bodegaverde.pe", website: "bodegaverde.pe",
        category: "cafe", rating: 4.8, totalReviews: 187,
        description: "Café y tienda gourmet con productos orgánicos y de comercio justo. Ambiente relajado ideal para trabajar o reunirse.",
        lat: -12.1185, lng: -77.0265,
        imageUrl: "https://images.unsplash.com/photo-1737700088850-d0b53f9d39ec?w=800&q=80",
        hours: [
            { day: "Lunes",     open: "07:30", close: "21:00" },
            { day: "Martes",    open: "07:30", close: "21:00" },
            { day: "Miércoles", open: "07:30", close: "21:00" },
            { day: "Jueves",    open: "07:30", close: "21:00" },
            { day: "Viernes",   open: "07:30", close: "22:00" },
            { day: "Sábado",    open: "08:00", close: "22:00" },
            { day: "Domingo",   open: "09:00", close: "20:00" },
        ],
    },
    {
        id: "b-vivanda", ruc: "20100022398", name: "Vivanda",
        address: "Ovalo Gutiérrez, Miraflores", district: "Miraflores",
        phone: "01 614-0000", email: "atencion@vivanda.com.pe", website: "vivanda.com.pe",
        category: "shop", rating: 4.6, totalReviews: 1204,
        description: "Supermercado premium de la cadena Wong con amplia selección de productos frescos, importados y de especialidad.",
        lat: -12.1278, lng: -77.0335,
        imageUrl: "https://images.unsplash.com/photo-1714224247661-ee250f55a842?w=800&q=80",
        hours: [
            ...
            { day: "Domingo",   open: "09:00", close: "21:00" },
        ],
    },
    {
        id: "b-spa-luna", ruc: "20601234567", name: "Spa Luna",
        address: "Calle Las Camelias 750, San Borja", district: "San Borja",
        phone: "01 346-8821", email: "reservas@spaluna.pe", website: "spaluna.pe",
        category: "services", rating: 4.9, totalReviews: 142,
        description: "Centro de bienestar y relajación especializado en masajes terapéuticos, tratamientos faciales y terapias de aromaterapia.",
        lat: -12.1295, lng: -77.0240,
        imageUrl: "https://images.unsplash.com/photo-1757689314932-bec6e9c39e51?w=800&q=80",
        hours: [
            ...
            { day: "Domingo",   closed: true, open: "—", close: "—" },
        ],
    },
    {
        id: "b-farmacia-cv", ruc: "20512345678", name: "Farmacia Cruz Verde",
        address: "Av. Larco 880, Miraflores", district: "Miraflores",
        phone: "0800-10606", email: "atencion@cruzverde.com.pe", website: "cruzverde.com.pe",
        category: "health", rating: 4.5, totalReviews: 96,
        description: "Cadena de farmacias con la mayor variedad de medicamentos, productos de salud y bienestar. Atención farmacéutica personalizada.",
        lat: -12.1265, lng: -77.0252,
        imageUrl: "https://images.unsplash.com/photo-1739289696449-cba3a5ef085d?w=800&q=80",
        hours: [
            { day: "Lunes",     open: "08:00", close: "22:00" },
            { day: "Martes",    open: "08:00", close: "22:00" },
            { day: "Miércoles", open: "08:00", close: "22:00" },
            { day: "Jueves",    open: "08:00", close: "22:00" },
            { day: "Viernes",   open: "08:00", close: "22:00" },
            { day: "Sábado",    open: "08:00", close: "22:00" },
            { day: "Domingo",   open: "09:00", close: "21:00" },
        ],
    },
    {
        id: "b-canta-rana", ruc: "20482345678", name: "La Canta Rana",
        address: "Génova 101, Barranco", district: "Barranco",
        phone: "01 247-7274", email: "reservas@lacantarana.pe",
        category: "food", rating: 4.7, totalReviews: 1120,
        description: "Cevichería emblemática de Barranco con más de 40 años de tradición. Especialidad en ceviche mixto, chicharrón de pescado y tiradito.",
        lat: -12.1494, lng: -77.0213,
        imageUrl: "https://images.unsplash.com/photo-1611262359546-64e2822b2ab5?w=800&q=80",
        hours: [
            { day: "Lunes",     closed: true, open: "—", close: "—" },
            { day: "Martes",    open: "12:00", close: "17:00" },
            { day: "Miércoles", open: "12:00", close: "17:00" },
            { day: "Jueves",    open: "12:00", close: "17:00" },
            { day: "Viernes",   open: "12:00", close: "18:00" },
            { day: "Sábado",    open: "12:00", close: "18:00" },
            { day: "Domingo",   open: "12:00", close: "17:00" },
        ],
    },
    {
        id: "b-barranco-beer", ruc: "20567890123", name: "Barranco Beer Company",
        address: "Av. Grau 308, Barranco", district: "Barranco",
        phone: "01 252-0170", email: "hola@barrancobeers.pe", website: "barrancobeers.pe",
        category: "cafe", rating: 4.5, totalReviews: 278,
        description: "Bar y cervecería artesanal con más de 20 estilos de cerveza de producción propia. Ambiente distendido con vista al Puente de los Suspiros.",
        lat: -12.1465, lng: -77.0229,
        imageUrl: "https://images.unsplash.com/photo-1758165532022-a68f291317ba?w=800&q=80",
        hours: [
            { day: "Lunes",     closed: true, open: "—", close: "—" },
            { day: "Martes",    open: "17:00", close: "00:00" },
            { day: "Miércoles", open: "17:00", close: "00:00" },
            { day: "Jueves",    open: "17:00", close: "01:00" },
            { day: "Viernes",   open: "15:00", close: "02:00" },
            { day: "Sábado",    open: "15:00", close: "02:00" },
            { day: "Domingo",   open: "15:00", close: "23:00" },
        ],
    },
    {
        id: "b-fitlife", ruc: "20498765432", name: "Fitness Point Miraflores",
        address: "Av. Reducto 1254, Miraflores", district: "Miraflores",
        phone: "01 445-9910", email: "info@fitnesspoint.pe", website: "fitnesspoint.pe",
        category: "services", rating: 4.5, totalReviews: 184,
        description: "Gimnasio boutique con equipamiento de última generación. Clases grupales de spinning, yoga, funcional y pilates a cargo de entrenadores certificados.",
        lat: -12.1194, lng: -77.0310,
        imageUrl: "https://images.unsplash.com/photo-1467818488384-3a21f2b79959?w=800&q=80",
        hours: [
            ...
            { day: "Viernes",   open: "06:00", close: "21:00" },
            { day: "Sábado",    open: "07:00", close: "19:00" },
            { day: "Domingo",   open: "08:00", close: "14:00" },
        ],
    },
];

export function getBusinessForCoupon(coupon: Coupon): Business {
    const match = BUSINESSES.find(b => b.name === coupon.brand);
    ...
    return {
        ...
        district: coupon.address.split(",").pop()?.trim() ?? "Lima",
        category: coupon.category,
        description: "",
        rating: coupon.rating,
        totalReviews: coupon.reviews,
        lat: coupon.lat,
        lng: coupon.lng,
        hours: DEFAULT_HOURS,
    };
