...
export const TweakSection: FC<TweakSectionProps> = ({ title, label, children }) => (
  <>
...
export const TweakRow: FC<TweakRowProps> = ({ label, value, inline = false, children }) => (
...
export const TweakSlider: FC<TweakSliderProps> = ({ label, value, min = 0, max = 100, step = 1, unit = "", onChange }) => (
...
export const TweakColor: FC<TweakColorProps> = ({ label, value, onChange }) => (
  <div className="twk-row twk-row-h">
    <div className="twk-lbl"><span>{label}</span></div>
